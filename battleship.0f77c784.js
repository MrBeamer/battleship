...
class GameController {
    ...
    init() {
        ...
        this.view.renderGameBoardFields(this.gameBoard.getCoordinatesLetters, this.gameBoard.getCoordinatesNumbers);
    }
    reset() {
        console.log("reset");
        this.selectedShip = null;
        ...
        for (let gameField of this.view.gameBoard.children)gameField.classList.remove("placed");
    }
}

},{"./GameView.js":"jq6mE","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT","./Gameboard.js":"2AAYy","./Ship.js":"4RmjJ"}],"jq6mE":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class GameView {
    ...
    renderGameBoardFields(coordinatesLetters, coordinatesNumbers) {
        for(let i = 1; i <= 100; i++)this.gameBoard.insertAdjacentHTML("beforeend", `<div class="gameboard-field" data-coord-x="${coordinatesNumbers(i)}" data-coord-y="${coordinatesLetters(i)}" data-coords="${coordinatesLetters(i)}${coordinatesNumbers(i)}">${coordinatesLetters(i)}-${coordinatesNumbers(i)}</div>`);
    }
    ...
    isOverLapping(fleetPlayer1) {
        const checkedFields = this.currentTargetFields.map((field)=>{
            ...
            return fleetPlayer1.some((ship)=>ship.position.includes(field.dataset.coords));
        });
...
},{}],"2AAYy":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"4RmjJ":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
